#!/usr/bin/env python3
"""
Patch: add Article + FAQPage + BreadcrumbList schema to juguetestem blog/[slug]/page.tsx
Run from the juguetestem repo root: python3 juguetestem-blog-slug-schema.patch.py
"""
import sys
...
SCHEMA_BLOCK = '''
  const articleSchema = {
    ...
    url: `https://www.juguetestem.es/blog/${slug}`,
    mainEntityOfPage: `https://www.juguetestem.es/blog/${slug}`,
    author: { "@type": "Organization", name: "JugueteSTEM.es" },
    publisher: {
      "@type": "Organization",
      name: "Mkt Web 360 SLU",
      url: "https://www.juguetestem.es",
      logo: { "@type": "ImageObject", url: "https://www.juguetestem.es/logo.png" },
    },
    inLanguage: "es",
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: post.title, item: `https://www.juguetestem.es/blog/${slug}` },
    ],
  };
