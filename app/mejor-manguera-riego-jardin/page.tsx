      ...
      <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-10 lg:items-start">
        ...
        <div className="prose">
          <h2>Tipos de manguera de jardín — ¿Cuál te conviene?</h2>
            ...
            <p className="text-gray-800 font-medium leading-relaxed">Antes de elegir un modelo concreto, conviene saber qué tipo de manguera se ajusta mejor a tu jardín y a tu uso:</p>
          </div>
        ...
        <div className="mt-6 p-6 bg-blue-50 rounded-xl border border-blue-200">
          ...
          <p className="text-sm text-gray-600 mb-4">Da el salto al riego automático y olvídate de la manguera manual.</p>
          <Link href="/tienda/riego-automatico" className="inline-block bg-sky-600 text-white font-semibold px-5 py-3 rounded-xl hover:bg-sky-700 transition-colors">
            Ver sistemas de riego automático →
          </Link>
        </div>
