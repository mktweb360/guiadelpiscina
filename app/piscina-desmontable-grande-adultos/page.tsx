    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="prose">
          ...
          <p>
            No es lo mismo una piscina para que los niños chapoteen que una en la que un adulto pueda refrescarse o incluso nadar. Para poder <strong>nadar</strong>, busca al menos 4 m de longitud y 1 m de profundidad. Para <strong>refrescarse cómodamente</strong> entre varios adultos, un diámetro de 3,5-4 m y 90-120 cm de profundidad es suficiente. Esta tabla te orienta según el uso:
          </p>
        </div>
