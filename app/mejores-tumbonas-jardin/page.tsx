    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="prose">
          ...
          <p>
            Una buena tumbona es la diferencia entre disfrutar del jardín o la piscina y acabar con dolor de espalda. Antes de comprar, fíjate en estos cinco factores:
          </p>
          <ul>
